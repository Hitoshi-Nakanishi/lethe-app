...
UI_TEXT = {
    "ja": {
        ...
        "save_audio_while_busy": "文字起こしなどの処理中です。完了してから MP3 を保存してください。",
    ...
    "en": {
        ...
        "mp3_saving": "Saving MP3...",
        "dataset_saving": "Exporting dataset...",
        ...
        "save_audio_while_busy": "Transcription or another task is still running. Save the MP3 after it finishes.",
